...
public class ButtonTestWithCSS {
    ...
    public void DemoQAOnGoogle(){
        ...
        WebElement button = driver.findElement(By.cssSelector("#item-4 > span"));
        button.click();

        //Click Me butonunu bul ve tıkla
        WebElement button2 = driver.findElement(By.cssSelector("button.btn.btn-primary:not(#rightClickBtn):not(#doubleClickBtn)"));
        button2.click();
